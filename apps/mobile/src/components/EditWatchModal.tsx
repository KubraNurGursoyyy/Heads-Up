      ...
      <View style={styles.backdrop}>
        <View style={styles.modal}>
          ...
          <Text style={styles.description}>
            İsteği değiştirebilir, haberde mutlaka bulunmasını istediğin kelimeleri yeniden seçebilirsin.
          </Text>
          ...
          <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} style={styles.scroll}>
            <Field
              ...
              style={styles.field}
            />
            <RequiredTermsPicker text={cleanPrompt} selected={requiredTerms} onChange={setRequiredTerms} compact />
          </ScrollView>
...
const styles = StyleSheet.create({
  backdrop: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20, backgroundColor: 'rgba(25,5,18,0.58)' },
  modal: { width: '100%', maxWidth: 470, maxHeight: '84%', padding: 20, borderRadius: 18, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderStrong },
  goldLine: { width: 42, height: 2, backgroundColor: colors.gold, marginBottom: 12 },
  kicker: { fontFamily: fontFamilyMedium, color: colors.magenta, fontSize: 9, fontWeight: '800', letterSpacing: 1.4 },
  title: { fontFamily: fontFamilyMedium, color: colors.ink, fontSize: 20, fontWeight: '800', marginTop: 5 },
  ...
  actions: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', gap: 8, marginTop: 15 },
  cancel: { minHeight: 46, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center', borderRadius: 10, borderWidth: 1, borderColor: colors.borderStrong },
